...
const quizQuestions = randoSequence(questions.length);
const lastQuestion = numberQuestions - 1;
...
function checkAnswer(answer){
    if( answer == questions[quizQuestions[runningQuestion]].correct){
        // answer is correct
        score++;
...
function scoreRender(){
    ...
    const scorePerCent = Math.round(100 * score/numberQuestions);
